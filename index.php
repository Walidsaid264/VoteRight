 ...
 <nav class="navbar navbar-expand-lg " style="background-color: #5358C6;">
  ...
  <div class="container-fluid">
	...
	<div class="col-sm-4 coloverlay " style="background-color:rgba(230, 218, 230, 0.785) ;  height: 350px;">
		<h2>VOTE RIGHT ONLINE VOTING MODULE</h2>
		<a href="vote.php" class="btn btn-primary btn-lg" tabindex="-1" role="button" aria-disabled="true">Start Voting!</a>
	</div>
	<div class="col-sm-8 offset-3 ">
		<img src="images/vote4.png" alt=""   width="1039px" height="530px">
	</div>
</div>
</div>
<!-- midpart 2 -->
<div class="container">
    <div class="row justify-content-around">
        <div class="col-sm-5 offset-1 midlinks"> View the Contestants<br><a class="active btn btn-primary btn-lg"  style="border: 1px solid gray; " href="manifestos.php">View Contestants</a> </div>
        <div class="col-sm-5 offset-1 midlinks results" > View the Results<br><a class="active btn btn-primary btn-lg"  style="border: 1px solid gray; " href="view_results.php">View Results</a> </div>
    </div>
</div>
    <!-- footer -->
    <div class="container-fluid">
